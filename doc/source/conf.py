...
# Load extensions from sources/_ext
...
# 'default' theme is slightly better than sphinx theme, as it is more contrasted
...
latex_elements = {
    'classoptions': ',openany',             # To avoid to many blank pages
    'babel': '\\usepackage[english]{babel}',
    # 'babel': '\\usepackage[french]{babel}',  # French document translation (Chapitre, Table des matières, ...), to be used instead of english in case of french documentation
    # This is needed in order for the inline code to be better formatted
    'preamble': r'''
        \usepackage{tcolorbox}
        \tcbuselibrary{listingsutf8}

        % Define a custom style for inline code with background color
        \newtcbox{\myinlinecode}{on line, boxsep=2pt,left=0pt, right=0pt, top=0pt, bottom=0pt,
                                colback=white!90, colframe=gray!25,
                                fontupper=\ttfamily\color{red!75}, nobeforeafter }

        \renewcommand{\sphinxcode}[1]{\myinlinecode{#1}}
        '''
}
